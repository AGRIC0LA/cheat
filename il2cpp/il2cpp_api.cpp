...
#define DO_APII(r, n, p) decltype(il2cpp_api::n) il2cpp_api::n;
...
#define DO_APII(r, n, p) il2cpp_api::n = (decltype(il2cpp_api::n))GetProcAddress(GetModuleHandleA("GameAssembly.dll"), #n);
void il2cpp_api::initialize() {
	DO_APII(void, il2cpp_init, (char* domain_name));
	DO_APII(void, il2cpp_init_utf16, (Il2CppChar * domain_name));
	DO_APII(void, il2cpp_shutdown, ());
	DO_APII(void, il2cpp_dumping_memory, (bool val));
	...
	// assembly
	typedef Il2CppImage* (__fastcall* il2cpp_assembly_get_image_t)(Il2CppAssembly* assembly); il2cpp_assembly_get_image = (il2cpp_assembly_get_image_t)GetProcAddress(GetModuleHandleA("GameAssembly.dll"), "il2cpp_assembly_get_image");;
