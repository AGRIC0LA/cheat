...
namespace ImGui
{
    ...
    IMGUI_API bool          tab_vidvigaemyi(ImVec2& position, bool* is_open, int* offset_from_tab, int* current_tab);
    IMGUI_API bool          rav_button(ImVec2 min, ImVec2 max, ImColor base_color, const char* name);
